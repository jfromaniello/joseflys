        ...
        <table className="w-full text-left text-xs">
          <thead>
            <tr className="text-[10px] uppercase tracking-wider text-slate-500">
              ...
              <th className="px-3 py-2 font-semibold text-right">Altitude</th>
              <th className="px-3 py-2 font-semibold text-right">Avg V/S</th>
            ...
            {phases.map((ph, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-2 tabular-nums text-slate-400">{formatUtcShort(ph.startMs)}</td>

              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p
                    ...
                    style={{ color: "oklch(0.65 0.02 240)" }}
                  >
                    Interactive map with 1468 aerodromes and LADs in Argentina.
                    AI-powered search to find airstrips by location and features
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 text-sm font-medium" style={{ color: "oklch(0.65 0.15 230)" }}>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p
                    ...
                    style={{ color: "oklch(0.65 0.02 240)" }}
                  >
                    Visualize how IAS, TAS and Mach are linked at altitude.
                    Hold one constant, watch the others move as you climb or change ISA temperature
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p
                    ...
                    style={{ color: "oklch(0.65 0.02 240)" }}
                  >
                    Draw shapes in the sky with GPS flight paths. Generate flight plans
                    for hearts, stars, and custom patterns over any location
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 text-sm font-medium" style={{ color: "oklch(0.65 0.15 290)" }}>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p
                    ...
                    style={{ color: "oklch(0.65 0.02 240)" }}
                  >
                    Replay any GPX flight track in a 3D globe with smooth time-based
                    animation. Scrub, play at 10x/50x/100x, and share the moment
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 text-sm font-medium" style={{ color: "oklch(0.65 0.15 290)" }}>
